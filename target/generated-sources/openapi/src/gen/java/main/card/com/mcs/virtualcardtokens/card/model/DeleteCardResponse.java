...
public class DeleteCardResponse {
  ...
  public DeleteCardResponse srcCorrelationId(String srcCorrelationId) {
  ...
  **/
   ...
   * @return the DeleteCardResponse instance itself
   */
  public DeleteCardResponse putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    DeleteCardResponse deleteCardResponse = (DeleteCardResponse) o;
    return Objects.equals(this.srcCorrelationId, deleteCardResponse.srcCorrelationId)&&
        Objects.equals(this.additionalProperties, deleteCardResponse.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(srcCorrelationId, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class DeleteCardResponse {\n");
  ...
  * @throws IOException if the JSON Element is invalid with respect to DeleteCardResponse
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DeleteCardResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DeleteCardResponse is not found in the empty JSON string", DeleteCardResponse.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : DeleteCardResponse.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DeleteCardResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DeleteCardResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DeleteCardResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DeleteCardResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<DeleteCardResponse>() {
           @Override
           public void write(JsonWriter out, DeleteCardResponse value) throws IOException {
           ...
           @Override
           public DeleteCardResponse read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             validateJsonElement(jsonElement);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             DeleteCardResponse instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of DeleteCardResponse given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of DeleteCardResponse
  * @throws IOException if the JSON string is invalid with respect to DeleteCardResponse
  */
  public static DeleteCardResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DeleteCardResponse.class);
  }

 /**
  * Convert an instance of DeleteCardResponse to an JSON string
  *
  * @return JSON string
  */
