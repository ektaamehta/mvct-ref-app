...
public class AssuranceData {
  ...
  public AssuranceData verificationData(List<VerificationData> verificationData) {
    this.verificationData = verificationData;
    return this;
  }

  public AssuranceData addVerificationDataItem(VerificationData verificationDataItem) {
    if (this.verificationData == null) {
      this.verificationData = new ArrayList<>();
    }
    this.verificationData.add(verificationDataItem);
    return this;
  }
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.verificationData, assuranceData.verificationData)&&
        Objects.equals(this.additionalProperties, assuranceData.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(verificationData, additionalProperties);
  }
  ...
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if (jsonObj.get("verificationData") != null && !jsonObj.get("verificationData").isJsonNull()) {
        JsonArray jsonArrayverificationData = jsonObj.getAsJsonArray("verificationData");
        if (jsonArrayverificationData != null) {
          // ensure the json data is an array
          if (!jsonObj.get("verificationData").isJsonArray()) {
            throw new IllegalArgumentException(String.format("Expected the field `verificationData` to be an array in the JSON string but got `%s`", jsonObj.get("verificationData").toString()));
          }

          // validate the optional field `verificationData` (array)
          for (int i = 0; i < jsonArrayverificationData.size(); i++) {
            VerificationData.validateJsonElement(jsonArrayverificationData.get(i));
          };
        }
      }
  }
