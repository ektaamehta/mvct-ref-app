...
public class GetCardResponse {
  ...
  public GetCardResponse srcCorrelationId(String srcCorrelationId) {
  ...
  **/
  ...
  public GetCardResponse maskedCard(MaskedCard maskedCard) {
  ...
  **/
  ...
  public GetCardResponse encryptedPaymentData(String encryptedPaymentData) {
    this.encryptedPaymentData = encryptedPaymentData;
    return this;
  }

   /**
   * This object is subject to manual set-up. Object for encrypted payment data, including paymentToken and relevant token information. Integrators must work with their account managers to be able to receive a token in the get card response.
  ...
  **/
  ...
  public GetCardResponse keyFingerprintId(String keyFingerprintId) {
  ...
  **/
   ...
   * @return the GetCardResponse instance itself
   */
  public GetCardResponse putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    GetCardResponse getCardResponse = (GetCardResponse) o;
    return Objects.equals(this.srcCorrelationId, getCardResponse.srcCorrelationId) &&
        Objects.equals(this.maskedCard, getCardResponse.maskedCard) &&
        Objects.equals(this.encryptedPaymentData, getCardResponse.encryptedPaymentData) &&
        Objects.equals(this.keyFingerprintId, getCardResponse.keyFingerprintId)&&
        Objects.equals(this.additionalProperties, getCardResponse.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(srcCorrelationId, maskedCard, encryptedPaymentData, keyFingerprintId, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class GetCardResponse {\n");
  ...
  * @throws IOException if the JSON Element is invalid with respect to GetCardResponse
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GetCardResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GetCardResponse is not found in the empty JSON string", GetCardResponse.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : GetCardResponse.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GetCardResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GetCardResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GetCardResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GetCardResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<GetCardResponse>() {
           @Override
           public void write(JsonWriter out, GetCardResponse value) throws IOException {
           ...
           @Override
           public GetCardResponse read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             validateJsonElement(jsonElement);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             GetCardResponse instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of GetCardResponse given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of GetCardResponse
  * @throws IOException if the JSON string is invalid with respect to GetCardResponse
  */
  public static GetCardResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetCardResponse.class);
  }

 /**
  * Convert an instance of GetCardResponse to an JSON string
  *
  * @return JSON string
  */
