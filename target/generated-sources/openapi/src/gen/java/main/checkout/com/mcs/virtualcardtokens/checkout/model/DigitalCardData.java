...
public class DigitalCardData {
  ...
  **/
  ...
  public DigitalCardData isCoBranded(Boolean isCoBranded) {
  ...
  **/
  ...
  public DigitalCardData foregroundColor(String foregroundColor) {
   ...
   /**
   * Foreground color used to overlay text on top of the card image. This is always returned in Product Configuration object.
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(status, presentationName, descriptorName, artUri, artHeight, artWidth, pendingEvents, coBrandedName, isCoBranded, longDescription, foregroundColor, issuerName, additionalProperties);
  }
