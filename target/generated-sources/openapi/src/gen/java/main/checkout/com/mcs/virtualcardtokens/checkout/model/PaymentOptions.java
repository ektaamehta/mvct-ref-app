...
public class PaymentOptions {
  ...
  public PaymentOptions dynamicDataType(DynamicDataType dynamicDataType) {
  ...
  **/
   ...
   * @return the PaymentOptions instance itself
   */
  public PaymentOptions putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.dynamicDataType, paymentOptions.dynamicDataType)&&
        Objects.equals(this.additionalProperties, paymentOptions.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(dynamicDataType, additionalProperties);
  }
  ...
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      // validate the optional field `dynamicDataType`
      if (jsonObj.get("dynamicDataType") != null && !jsonObj.get("dynamicDataType").isJsonNull()) {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<PaymentOptions>() {
           ...
           public PaymentOptions read(JsonReader in) throws IOException {
             ...
             PaymentOptions instance = thisAdapter.fromJsonTree(jsonObj);
