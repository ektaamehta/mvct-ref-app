...
public class Consent {
  public static final String SERIALIZED_NAME_ACCEPTED_VERSION = "acceptedVersion";
  @SerializedName(SERIALIZED_NAME_ACCEPTED_VERSION)
  ...
  public static final String SERIALIZED_NAME_LATEST_VERSION_URI = "latestVersionUri";
  @SerializedName(SERIALIZED_NAME_LATEST_VERSION_URI)
  private String latestVersionUri;

  public Consent() {
  }

  public Consent acceptedVersion(String acceptedVersion) {
    this.acceptedVersion = acceptedVersion;
    return this;
  }

   /**
   * Version accepted by the Consumer.
  ...
  **/
  ...
  public Consent latestVersion(String latestVersion) {
  ...
  **/
  ...
  public Consent latestVersionUri(String latestVersionUri) {
    this.latestVersionUri = latestVersionUri;
    return this;
  }

   /**
   * URI of the latest version.
  ...
  **/
  ...
  public void setLatestVersionUri(String latestVersionUri) {
    this.latestVersionUri = latestVersionUri;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.acceptedVersion, consent.acceptedVersion) &&
        Objects.equals(this.latestVersion, consent.latestVersion) &&
        Objects.equals(this.latestVersionUri, consent.latestVersionUri)&&
        Objects.equals(this.additionalProperties, consent.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(acceptedVersion, latestVersion, latestVersionUri, additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("    acceptedVersion: ").append(toIndentedString(acceptedVersion)).append("\n");
    sb.append("    latestVersion: ").append(toIndentedString(latestVersion)).append("\n");
    sb.append("    latestVersionUri: ").append(toIndentedString(latestVersionUri)).append("\n");
  ...
  static {
    ...
    openapiFields.add("acceptedVersion");
    openapiFields.add("latestVersion");
    openapiFields.add("latestVersionUri");
  ...
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if ((jsonObj.get("acceptedVersion") != null && !jsonObj.get("acceptedVersion").isJsonNull()) && !jsonObj.get("acceptedVersion").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `acceptedVersion` to be a primitive type in the JSON string but got `%s`", jsonObj.get("acceptedVersion").toString()));
      }
      ...
      if ((jsonObj.get("latestVersionUri") != null && !jsonObj.get("latestVersionUri").isJsonNull()) && !jsonObj.get("latestVersionUri").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `latestVersionUri` to be a primitive type in the JSON string but got `%s`", jsonObj.get("latestVersionUri").toString()));
      }
  }
